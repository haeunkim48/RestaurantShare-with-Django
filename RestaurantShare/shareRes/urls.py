...
urlpatterns = [
    ...
    path ('restaurantDetail/<str:res_id>', views.restaurantDetail, name ='resDetialPage'),
    path ('restaurantDetail/updatePage/update', views.Update_restaurant, name = 'resUpdate'),
    path ('restaurantDetail/updatePage/<str:res_id>', views.restaruantUpdate, name = 'resUpdatePage'),
